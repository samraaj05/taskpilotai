        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between text-xs">
            ...
            <div className="flex items-center gap-1.5 text-slate-400">
              ...
              {project.memberCount ?? project.member_emails?.length ?? 0} members
            </div>
          </div>

          {(project.teamData?.length > 0 || project.member_emails?.length > 0) && (
            <div className="flex items-center -space-x-2 pt-2">
              {(project.teamData || project.member_emails).slice(0, 4).map((email, i) => (
